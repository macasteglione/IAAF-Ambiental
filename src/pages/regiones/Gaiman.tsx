    ...
    <div className="min-h-screen">
      <SEO 
        ...
        localBusinessSchema={{
          ...
          description: "Servicios de consultoría ambiental en Gaiman, localidad histórica galesa del Valle Inferior",
          areaServed: ["Gaiman Centro", "Barrio Trevelin", "Barrio 28 de Julio", "Chacras Gaiman", "Zona Rural Gaiman", "Parque Paleontológico", "Zona Turística", "Gaiman Norte", "Gaiman Sur", "Zona de Expansión"],
