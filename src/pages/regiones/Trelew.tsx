    ...
    <div className="min-h-screen">
      <SEO 
        ...
        localBusinessSchema={{
          ...
          description: "Servicios de consultoría ambiental en la ciudad de Trelew y su zona de influencia",
          areaServed: ["Trelew Centro", "Parque Industrial Trelew", "Barrio Centenario", "Barrio Don Bosco", "Barrio Moreira", "Chacras Trelew", "Zona Rural Trelew", "Trelew Norte", "Trelew Sur", "Zona de Expansión"],
