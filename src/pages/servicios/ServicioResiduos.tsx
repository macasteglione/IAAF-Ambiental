...
const ServicioResiduos = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="h-screen lg:h-[550px] bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 relative overflow-hidden flex items-center pt-16 sm:pt-20 pb-8 sm:pb-12">
