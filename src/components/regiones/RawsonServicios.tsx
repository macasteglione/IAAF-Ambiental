  ...
  const services = [
    {
      ...
      description:
        "Servicios ambientales especializados para proyectos del gobierno provincial y organismos del estado.",
      features: [
        "Edificios Públicos",
    ...
    },
    {
      ...
      description:
        "Asesoramiento ambiental para proyectos turísticos en Playa Unión, Puerto Rawson y zona costera.",
      features: [
    ...
    },
    {
      ...
      description:
        "Estudios de impacto ambiental y auditorías para proyectos comerciales y de servicios en la capital.",
      features: [
