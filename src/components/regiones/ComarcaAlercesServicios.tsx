  ...
  const services = [
    {
      ...
      description: "Servicios ambientales especializados para proyectos forestales y conservación de bosques nativos.",
      features: [
      ...
      suitableFor: ["Bosques Nativos", "Conservación", "Reforestación", "Gestión Forestal"]
    },
    {
      icon: Mountain,
      title: "Parque Nacional y Áreas Protegidas",
      description: "Asesoramiento ambiental para proyectos en Parque Nacional Los Alerces y áreas protegidas.",
      features: [
      ...
      suitableFor: ["Área Protegida", "Turismo", "Investigación", "Conservación"]
    },
    {
      icon: Hotel,
      title: "Turismo Cordillerano",
      description: "Estudios ambientales para proyectos turísticos en zona de montaña y lagos.",
      features: [
        "Hoteles y Hosterías",
        "Centros de Esquí",
        "Campings y Refugios",
