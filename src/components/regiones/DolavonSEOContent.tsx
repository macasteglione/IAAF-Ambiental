...
const DolavonSEOContent = () => {
  return (
    <div className="sr-only">
      <h2>Servicios Ambientales Dolavon - Cobertura Completa</h2>
      <p>IAAF Ambiental brinda servicios de consultoría ambiental, estudios de impacto ambiental, gestión de residuos y auditorías ambientales en Dolavon, localidad histórica de los molinos harineros, incluyendo:</p>
...
export default DolavonSEOContent;
