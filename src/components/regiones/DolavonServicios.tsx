  ...
  const services = [
    {
      ...
      description:
        "Servicios ambientales especializados para molinos harineros y patrimonio cultural galesa.",
      features: [
    ...
    },
    {
      ...
      description:
        "Asesoramiento ambiental para emprendimientos turísticos y circuitos culturales.",
      features: [
    ...
    },
    {
      ...
      description:
        "Estudios ambientales para chacras y establecimientos agropecuarios tradicionales.",
      features: [
        "Chacras y Quintas",
        "Producción Agrícola",
        "Sistemas de Riego",
