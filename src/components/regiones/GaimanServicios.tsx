  ...
  const services = [
    {
      ...
      description: "Servicios ambientales especializados para emprendimientos turísticos respetando el patrimonio cultural galesa.",
      features: [
        "Casas de Té Galesas",
      ...
      suitableFor: ["Casas de Té", "Hoteles", "Restaurantes", "Emprendimientos Turísticos"]
    },
    {
      icon: Sprout,
      title: "Proyectos Agropecuarios",
      description: "Asesoramiento ambiental para chacras y establecimientos agropecuarios tradicionales del valle.",
      features: [
        "Chacras y Quintas",
        "Producción Agrícola",
        "Sistemas de Riego",
    ...
    },
    {
      ...
      description: "Estudios ambientales para proyectos que preserven el patrimonio histórico y cultural galesa.",
      features: [
      ...
      suitableFor: ["Edificios Históricos", "Comercios", "Desarrollos", "Proyectos Culturales"]
    }
  ];
