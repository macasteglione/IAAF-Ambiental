      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg lg:text-xl xl:text-2xl text-white/95 mb-6 sm:mb-8 leading-relaxed px-4 sm:px-0">
            Consultoría ambiental especializada en la Patagonia con más de una década
            de experiencia brindando soluciones sustentables a empresas y organismos públicos.
          </p>
        </div>
      </div>
    </section>
